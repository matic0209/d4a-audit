...
contract("D4AProtocol for Price", function(accounts){
  context('basic test', async()=>{
    ...
    it('create project', async() =>{
      tx = await protocol.createProject(5, 50, 1, 1, rf, "uri here 1", {from:accounts[0], value:'1000000000000000000'});
      ...
      tx = await protocol.createProject(5, 50, 1, 1, rf, "uri here 2", {from:accounts[0], value:'1000000000000000000'});
      e = tx.logs[tx.logs.length - 1]
