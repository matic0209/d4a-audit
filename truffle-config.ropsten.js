...
module.exports = {
  ...
  networks: {
    ...
    // NB: It's important to wrap the provider as a function.
     goerli: {
       provider: new HDWalletProvider(process.env.ROPSTEN_PK, "https://goerli.infura.io/v3/" + process.env.INFURA_API_KEY),
       //provider: new PrivateKeyProvider(process.env.ROPSTEN_PK, "https://goerli.infura.io/v3/" + process.env.INFURA_API_KEY),
